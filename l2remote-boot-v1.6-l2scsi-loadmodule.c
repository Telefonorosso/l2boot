/*
 * l2remote.boot 1.6 - standalone LoadModule-compatible RDB bootstrap
 *
 * Purpose:
 *   After LoadModule has installed l2scsi.device and ptable.library, this
 *   COLDSTART resident opens ptable.library and calls:
 *
 *       BootScanRDB("l2scsi.device", 0)
 *
...
#define L2BOOT_REVISION   6
#define L2BOOT_PRIORITY   9
#define L2BOOT_VERSTRING  "$VER: l2remote.boot 1.6 (29.07.2026) standalone LoadModule RDB bootstrap for l2scsi.device fixed EndSkip"
 ...
 * (l2scsi.device uses priority 21; this module uses 9).  We still check the live
