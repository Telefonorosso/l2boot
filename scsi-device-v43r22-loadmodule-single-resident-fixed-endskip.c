 ...
 * Exposes the remote Pi HDF as scsi.device unit 0. Units 1+ fail to open.
...
#define L2SCSI_REVISION   22
#define L2SCSI_VERSTRING   "$VER: scsi.device 43.22 (27.07.2026) LoadModule single-Resident fixed-rt_EndSkip WRITE1024 TD_FORMAT native-RDB"
 ...
 * exports exactly one Resident, scsi.device.  Partition-table boot scanning
